...
class RegistrationModel
{
    ...
    public static function registerNewUser()
    {
        ...
        // EMAIL VERIFICATION REMOVED: generate random hash for email verification (40 bytes)
        ...
        // EMAIL VERIFICATION REMOVED: send verification email
        /*
    ...
    public static function registrationInputValidation($captcha, $user_name, $user_password_new, $user_password_repeat, $user_email, $user_email_repeat)
    {
        ...
        // CAPTCHA REMOVED: perform all necessary checks
        /*
